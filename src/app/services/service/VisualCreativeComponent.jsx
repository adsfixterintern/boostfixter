...
export default function VisualCreativeComponent() {
  const services = [
    {
      number: "01",
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div className="space-y-5 lg:text-left">
              <h1 className="title ">Visual & Creative</h1>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              <div
                key={service.number}
                className="flex flex-col justify-between p-6 transition-all duration-300 bg-[#F8F8F8] rounded-xl "
              >
                <div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-9">
            ...
            <div className="space-y-5 text-center md:text-left md:col-span-5 ">
              ...
              <p className="description">
                ...
                something extraordinary. Reach out to us, and we&apos;ll help
